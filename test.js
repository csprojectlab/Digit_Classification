...
function preload() {
  training = loadStrings('./data/train_10000.csv', () => console.log("Training data loaded"))
  testing = loadStrings('./data/test_1000.csv', () => console.log("Testing data loaded"))
}
function setup() {
  // Canvas
...
function mouseDragged() {
  ...
  if (mouseX > ux && mouseY > uy && mouseX < ux + uw && mouseY < uy + uw) {
    ...
    userPixels.ellipse(mouseX -  ux - ux, mouseY - uy - 8, 8, 8);
